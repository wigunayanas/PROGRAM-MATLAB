...
guidata(hObject, handles);
axes(handles.axes_foto); %memilih axes_foto sebagai letak gambar yang dimunculkan
imshow(image); %memunculkan gambar
set(handles.text24,'String',namafile)
...
if get(handles.sim_baru, 'Value')
    if get(handles.sim_a, 'Value')
        ...
        set(handles.text_info, 'String', 'Bagi Pemohon SIM A Baru, biaya pembuatan SIM sebesar Rp. 150.000 dengan No.Rek BRI 0067 921 2831')
    elseif get(handles.sim_c, 'Value')
        ...
        set(handles.text_permohonan, 'String','SIM Baru') %---- permohonan
        set(handles.text_info, 'String', 'Bagi Pemohon SIM C Baru, biaya pembuatan SIM sebesar Rp. 100.000 dengan No.Rek BRI 0067 921 2831')
    end
elseif get(handles.perpanjang_sim, 'Value')
    if get(handles.sim_a, 'Value')
        ...
        set(handles.text_info, 'String', 'Bagi pemohon perpanjangan SIM A, biaya perpanjangan SIM sebesar Rp. 100.000 dengan No.Rek BRI 0067 921 2831')
    elseif get(handles.sim_c, 'Value')
        nama = get(handles.edit_nama, 'String'); %---- nama
        set(handles.text_nama, 'String',nama)
        nik = get(handles.edit_nik, 'String'); %---- nik
        ...
        set(handles.text_jenis, 'String','SIM C') %---- jenis sim
        set(handles.text_permohonan, 'String','Perpanjangan SIM') %---- permohonan
        set(handles.text_info, 'String', 'Bagi pemohon perpanjangan SIM C, biaya perpanjangan SIM sebesar Rp. 100.000 dengan No.Rek BRI 0067 921 2831')
    end
end
